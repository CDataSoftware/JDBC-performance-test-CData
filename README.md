...
Notes: specify the class path for your JDBC driver, along with root directory itself. Can specify a speicific query from the queries.sql file, or specify "all." The number at the end is the number of runs for each query.
Running (from root):
